...
<template>
  <Section ref="sectionRef" padding="2xl" class="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-brand-red/5">
    ...
    <Container class="relative z-10">
      <div class="text-center mb-16 flex flex-col items-center">
        <div class="export-heading inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-brand-blue/10 to-brand-red/10 rounded-full mb-6 mx-auto">
          <svg class="w-5 h-5 text-brand-blue mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <span class="text-sm font-bold text-brand-blue">МЕЖДУНАРОДНОЕ ПРИСУТСТВИЕ</span>
        </div>

        <h2 class="export-heading text-3xl md:text-4xl lg:text-5xl font-black mb-6 text-center">
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-brand-red via-red-500 to-brand-blue">
            География экспорта
          </span>
        </h2>
        <p class="export-subtitle text-xl text-gray-600 max-w-2xl mx-auto text-center">
      ...
      <Card variant="elevated" padding="2xl" class="border-0 shadow-2xl bg-white/80 backdrop-blur-sm">
  ...
  <!-- Отступ после секции -->
  <div class="h-12 bg-gradient-to-b from-transparent to-white"></div>
</template>
